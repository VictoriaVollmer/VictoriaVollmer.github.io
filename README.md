<html>
  <head>
    ...
    <title>Victoria Vollmer : Programming Languages, Computer Science</title>
  </head>
  <header>
    <a class="logo">Victoria Vollmer</a>
  </header>
  <body>
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-4 col-lg-2 col-lg-offset-2">
          <h2>About Me</h2>
          <p>Hello! I’m a computer scientist who studies programming languages and category theory. I'm currently a phd student at the University of Kent. Previously, I completed my ms at Indiana University.</p>
          <p>I am not an interesting person.</p>
